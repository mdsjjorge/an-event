export const defaultEvent = {
  slug: "main-event",
  navTitle: "Nosso Evento",
  eventTitle: "Ajude-nos a construir nosso novo lar",
  eventSubtitle:
    "Preparamos esta lista com muito carinho para equipar nossa casinha. Fique a vontade para escolher um item ou contribuir com qualquer valor!",
  giftSectionTitle: "Lista de Presentes",
  giftSectionDescription:
    "Escolha um item para nos presentear. Ao selecionar, voce recebera um QR Code Pix para pagamento.",
  rsvpTitle: "Confirmar Presenca",
  rsvpDescription:
